...
import { FileText, Plus, Settings, Clock, Users, Eye } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer border-dashed border-2 border-slate-200 dark:border-slate-700 bg-white/50 dark:bg-slate-800/50 group">
              <CardHeader className="text-center">
                ...
                <div className="pt-4">
                  <Button onClick={() => window.location.href = '/forms/designer'}>
                    Get Started
                  </Button>
                </div>
              </CardHeader>
              ...
              <CardContent>
                {isLoading ? (
                  ...
                  <div className="text-center py-12 text-slate-500 dark:text-slate-400">
                    ...
                    <Button variant="outline" onClick={() => window.location.href = '/forms/designer'}>
