...
async function testRefreshTokenDirect() {
    try {
        // 1. Login with the verified test user
        console.log('1. Logging in with verified user...');
        ...
        console.log('3. Testing with invalid refresh token...');
        try {
        ...
        // 4. Test missing refresh token
        console.log('4. Testing with missing refresh token...');
        try {
            await axios.post(`${API_BASE_URL}/auth/refresh`, {});
